...
if (util.getTime() >= 18):
    ...
    print("Buongiorno..")
time.sleep(1)
print("\nSono Severus Piton, e sono qui per interrogarti..")
util.loading()

#parte relativa al riconoscimento del nome
risposta_nome = input("\nInanzitutto, come ti chiami?\n")
util.loading()
...
while(domande>0):
        ...
        print("La difficoltà attuale è: " + str(difficoltà))
        ...
        pozioneScelta_dict = util.selectPoison(difficoltà)
        ...
        if(risposta in ingredienti_pozione):
            ...
            if("ingrediente" in risposta):
               ...
               # if(str(rispostaParsata['ingrediente'][0]) == "nsubj" or str(rispostaParsata[ingredientePozione][0]) == "nsubj"):
